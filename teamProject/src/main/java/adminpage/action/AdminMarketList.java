...
public class AdminMarketList implements Action{

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// 객체생성 
		// 리턴할형 ArrayList<MarketDTO> getAllMarketList() 메서드 정의  
		...
		int count = dao.getAllMarketCount();  
		...
		forward.setPath("adminpage/adminBoard.jsp");
