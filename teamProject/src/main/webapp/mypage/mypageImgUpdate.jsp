...
<div class="boardContainer">
	...
	<div class=content>
		<form id="fr" action="MypageImgUpdatePro.mypage" method="post"
			...
			<ul>
				...
				<li><label>프로필사진</label> <input type="file" name="mem_img">
					<input type="hidden" name="oldfile" value="<%=dto.getMem_img()%>"><br>
				</li>

				<li><label>닉네임</label> <input type="text" name="nickname"
					value="<%=dto.getNickname()%>"><br></li>
			</ul>
			</p>
