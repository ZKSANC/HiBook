...
<div class="boardContainer">
	...
	<div class="tableBar">
		<table>
			...
			<tr>
				...
				<td><a
					href="MarketContent.ma?market_id=<%=dto.getMarket_id()%>"><%=dto.getTitle()%></a></td>
	...
	<div class=pageNum>
		...
		%>
		<a
			href="MypageUserMarketList.mypage?insert_id=<%=insert_id%>&nickname=<%=nickname%>&pageNum=<%=currentPage - 1%>">&lt;</a>
		<%
		}
		...
		%>
		<a
			href="MypageUserMarketList.mypage?insert_id=<%=insert_id%>&nickname=<%=nickname%>&pageNum=<%=i%>"><%=i%></a>
		<%
		}
